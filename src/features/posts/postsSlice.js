  ...
  async ({ userId, postId, newPostContent, newFile }) => {
    try {
      ...
      if (postSnap.exists()) {
        ...
        // Update the post content and the image URL and existing data of our post
        //const postData = {content : 'hello' , imageUrl: 'firebase.storage.com/photos/1', id: 1}

        const updatedData = {

        // if user don't want to update the text/ content of the tweet, it will be an empty string
        //empty string is a false y boolean
        // and the postData.content is "Hello"

          content: newPostContent || postData.content,
          imageUrl: newImageUrl || postData.imageUrl,
          // this also apply to image as well
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updatePost.fulfilled, (state, action) => {
        //action = {payload: {id:1 ,content:"goid", imageUrl: 'image.com/3'}}
        // state.posts =[
        // {id: 1, content: 'Hello', imageUrl: 'image.com/3'}
        // {id: 2, content: 'bonjour', imageUrl: 'image.com/4'}
        // ]
